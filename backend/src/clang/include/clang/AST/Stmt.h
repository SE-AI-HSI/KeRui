...
protected:
  ...
  class FixedStmtBitfields {
    friend class FixedStmt;

    unsigned : NumStmtBits;

    SourceLocation FixedStmtLoc;
  };
  ...
  union {
    ...
    FixedStmtBitfields FixedStmtBits;
...
class FixedStmt : public Stmt {
public:
  FixedStmt() : Stmt(FixedStmtClass) { }

  SourceLocation getFixedStmtLoc() const { return FixedStmtBits.FixedStmtLoc; }
  void setFixedStmtLoc(SourceLocation L) { FixedStmtBits.FixedStmtLoc = L; }

  SourceLocation getBeginLoc() const { return getFixedStmtLoc(); }
  SourceLocation getEndLoc() const { return getFixedStmtLoc(); }

  static bool classof(const Stmt *T) {
    return T->getStmtClass() == FixedStmtClass;
  }
